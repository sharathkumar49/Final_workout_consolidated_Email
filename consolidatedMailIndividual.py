...
if projdict:
    ...
    for tester in projdict:
        context = {"tester": tester, "testerData": projdict[tester], "previousRelease": "R15.0.0"}
...
for tester in testers:
    ...
    with open("./single_tester_data/{}_final.html".format(tester.replace(' ','_')),"a") as fileop:
        fileop.write(output)

print("\nFinished adding final data")
